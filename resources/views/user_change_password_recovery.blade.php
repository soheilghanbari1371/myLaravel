    ...
    <div class="page-content">
        ...
        <div class="content-wrapper">
            ...
            <div class="content">
                ...
                <!-- Password recovery -->
                <form action="{{url('user/password/recovery/register/token/submit')}}" method="post">
                    @csrf
                    <div class="panel panel-body login-form">
                        ...
                        <div class="form-group has-feedback">
                            <input type="password" name="password" class="form-control" placeholder="کلمه عبور جدید">

                            <div class="form-control-feedback">
                                <i class="icon-upload text-muted"></i>
                            </div>
                            <input type="password" name="password_retype" class="form-control" placeholder="تکرار کلمه عبور جدید">
                            <div class="form-control-feedback">
                                <i class="icon-mail5 text-muted"></i>
                            </div>
                            <input type="hidden" name="token" class="form-control" value="{{$token}}" hidden="hidden">
